...
function saveTour({ tour, geometry, stops, stopCoords, dailyKm, startDate, avoidShortFinal, id, name } = {}) {
  ...
  const blobWrite = writeBlob(id, { tour, geometry, stops, stopCoords, dailyKm, startDate, avoidShortFinal });
